...
FrMimeTypeDescription mime_type_desc[] = {
	...
	{ "application/x-bzip2",                ".bz2",      NULL, 0 },
	{ "application/x-bzip2-compressed-tar", ".tar.bz2",  N_("Tar compressed with bzip2 (.tar.bz2)"), 0 },
	...
	{ "application/vnd.efi.iso",             ".iso",     NULL, 0 },
	{ "application/vnd.efi.img",            ".img",      NULL, 0 },
	...
	{ "application/x-lz4",                  ".lz4",      N_("LZ4 compressed file (.lz4)"), 0 },
	{ "application/x-lz4-compressed-tar",   ".tar.lz4",  N_("Tar compressed with lz4 (.tar.lz4)"), 0 },
	...
	{ "application/vnd.rar",                ".rar",      N_("Rar (.rar)"), 0 },
	...
	{ "application/zstd",                   ".zst",      N_("Zstandard compressed file (.zst)"), 0 },
